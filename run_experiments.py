...
def run_one(instance,seed,cfg,budget,threads,domain):
    ...
    return {"instance":instance,"seed":seed,"algorithm":cfg["algorithm"],"budget":budget,"runtime":time.perf_counter()-started,"status":r.get("status_name"),"ub":r.get("ub"),"lb":r.get("lb"),"gap":r.get("gap"),"open_cost":components.get("open_cost"),"concentration_cost":components.get("concentration_cost"),"distance_cost":components.get("distance_cost"),"balance_cost":components.get("balance_cost"),"conflict_cost":components.get("conflict_cost"),"concentration_available":con.get("available"),"concentration_enabled":con.get("enabled"),"concentration_weight":cfg["weight"],"concentration_raw_excess_blocks":con.get("raw_excess_blocks"),"concentration_normalized":con.get("normalized"),"concentration_scale":con.get("scale"),"used_blocks_total":con.get("used_blocks_total"),"minimum_required_blocks_total":con.get("minimum_required_blocks_total"),"root_open_bound":root.get("master_open_bound"),"root_concentration_bound":root.get("master_concentration_bound"),"root_eta_bound":root.get("master_eta_bound"),"aggregate_recourse_bound":root.get("aggregate_recourse_bound"),"cuts":cuts,"sp_solves":sp,"callback_time":callback,"alns_improvement":alns,"nodes":nodes,"alloc_domain":domain}
def main():
