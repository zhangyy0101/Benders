...
def build_master_model(data,weights,*,alloc_domain="integer",relax=False,add_valid_inequalities=True,cut_pool=None,aggregate_recourse_lb=True,analytic_recourse_lb=True,redundant_block_binary=False):
    ...
    m.update();return m,vars,{"open_expression":open_expr,"remaining_capacity":rem,"aggregate":aggregate}
