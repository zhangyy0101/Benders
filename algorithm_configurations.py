...
CONFIGURATIONS={
 ...
 "candidate-v2-agfr-development":_cfg("candidate-v2-agfr-development",configuration_version="2-dev",status="development_candidate",aggregate_recourse_lb=True,primal_repair=True,primal_repair_method="aggregate_guided_fix_and_repair",primal_repair_time_share=.08,primal_repair_min_seconds=2.0,primal_repair_max_seconds=20.0,primal_repair_guide_share=.25,primal_repair_mip_gap=.05,primal_repair_max_expansions=2),
