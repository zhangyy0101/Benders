...
CONFIGURATIONS={
 ...
 "V2A_valid":_cfg("V2A_valid",base="algorithm-candidate-v1",aggregate_recourse_lb=True,aggregate_relaxation_level="size",valid_inequalities=True,valid_inequality_profile="common",configuration_version="2-dev",status="development_candidate_v2"),
 "V2B_pod_size_aggregate":_cfg("V2B_pod_size_aggregate",base="algorithm-candidate-v1",aggregate_recourse_lb=True,aggregate_relaxation_level="pod_size",configuration_version="2-dev",status="development_candidate_v2"),
 "V2C_pod_size_aggregate_valid":_cfg("V2C_pod_size_aggregate_valid",base="algorithm-candidate-v1",aggregate_recourse_lb=True,aggregate_relaxation_level="pod_size",valid_inequalities=True,valid_inequality_profile="common",configuration_version="2-dev",status="development_candidate_v2"),
