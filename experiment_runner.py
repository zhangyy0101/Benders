...
def _timing(raw,wall):
    main=raw.get("phase3_bbc",raw.get("main_solve",{}));root=raw.get("phase0_root_prepass",{});warm=raw.get("phase1_initialization",raw.get("warm_start",{}));alns=raw.get("phase2_alns",raw.get("alns",{}));repair=raw.get("phase_primal_repair",{});return {"wall_clock":wall,"solver_reported":raw.get("runtime"),"model_build":raw.get("model_build_runtime",main.get("model_build_runtime")),"solve":raw.get("optimization_runtime",main.get("optimization_runtime")),"root":root.get("root_cut_runtime"),"warm":warm.get("runtime"),"alns":alns.get("runtime"),"repair":repair.get("runtime"),"guide":repair.get("guide_runtime"),"main":main.get("runtime"),"callback":main.get("cut_statistics",{}).get("callback_time"),"sp_total":main.get("sp_statistics",raw.get("sp_statistics",{})).get("sp_total_time")}
