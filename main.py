...
def main():
    ...
    result = solve_true_benders_pipeline(
        ...
        valid_inequality_profile=configuration.get("valid_inequality_profile", "common"),
        aggregate_recourse_lb=configuration["aggregate_recourse_lb"],
        aggregate_relaxation_level=configuration.get("aggregate_relaxation_level", "size"),
