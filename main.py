...
def parser():
    p=argparse.ArgumentParser(description="True BBC + adaptive LNS + joint-group concentration")
    ...
    p.add_argument("--valid-inequalities",action=argparse.BooleanOptionalAction,default=True);p.add_argument("--alns",action=argparse.BooleanOptionalAction,default=True);p.add_argument("--warm-start",action=argparse.BooleanOptionalAction,default=True);p.add_argument("--concentration",action=argparse.BooleanOptionalAction,default=True);p.add_argument("--concentration-weight",type=float,default=10);p.add_argument("--concentration-mode",choices=("joint-group",),default="joint-group")
