...
本文件冻结当前代码的实验口径。公式以 `model_common.py`、`model_master.py`、
...
## 7. Fixed paper settings

机器可读值见 `paper_exp_v1_defaults.json`。当前冻结：integer allocation、handling
scale 1.0、proportional old-outbound release、joint-group-bay concentration、gap 0.03、
threads 1、基准 seed 0。集中性仅在属性完整、group arrivals 完整、开关开启且权重大于
0 时启用。
